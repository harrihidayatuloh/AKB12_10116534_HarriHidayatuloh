 ...
 *
 * */
public class kodek extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kodek);
        ...
        switch (v.getId()) {
            case R.id.btnLogin:
                if (TextUtils.isEmpty(kk)){
                    ...
                    Intent moveIntent = new Intent(com.example.lat1_akb12_10116534_harrihidayatuloh.kodek.this, bio.class);
